...
fun sumOfBigThree(vararg numbers: Int): Int {
    // Jika tidak ada input, kembalikan 0
    if (numbers.isEmpty()) return 0

    // Urutkan input dari besar ke kecil
    val sorted = numbers.sortedDescending()

    // Ambil tiga angka terbesar dari input
    val bigThree = sorted.take(3)

    // Jumlahkan tiga angka tersebut
    val sum = bigThree.sum()
